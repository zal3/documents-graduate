<div class="text-white flex flex-col gap-[10px] pt-5 fixed top-0 bottom-0 lg:right-0 w-[220px] bg-[#1E458A]">
    ...
    <div
        class="leading-9 text-gray-100 hover:bg-black hover:bg-opacity-30 {{ request()->is('document') ? '!bg-black !bg-opacity-30' : '' }}">
    ...
    <div
        class="leading-9 text-gray-100 hover:bg-black hover:bg-opacity-30 {{ request()->is('unid') ? '!bg-black !bg-opacity-30' : '' }}">
    ...
    <div
        class="leading-9 text-gray-100 hover:bg-black hover:bg-opacity-30 {{ request()->is('graduate') ? '!bg-black !bg-opacity-30' : '' }}">
    ...
    <div
        class="leading-9 text-gray-100 hover:bg-black hover:bg-opacity-30 {{ request()->is('science-subject') ? '!bg-black !bg-opacity-30' : '' }}">
        <button class="flex items-center text-[15px] font-normal rounded-lg transition duration-75 group"
            ...
            <li>
                <div class=" lg:right-0">
                    <button
                        ...
                        aria-controls="dropdown-exampleee" datax-collapse-toggle="dropdown-exampleee">
                        <span class="flex-1 ml-1 mr-3 whitespace-nowrap" sidebar-toggle-item>علوم
                            الحاسوب</span>
                        <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
    ...
    <div
        class="leading-9 text-gray-100 hover:bg-black hover:bg-opacity-30 {{ request()->is('developers') ? '!bg-black !bg-opacity-30' : '' }}">
        <a href="{{ route('developers') }}" class=" lg:right-0 pr-2.5 mt-1 flex items-center">
            <div class="pl-3">
                <svg width="30" height="20" viewBox="0 0 110 70" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M65.5 7L34.653 62.5246C33.7345 64.1779 34.3064 66.2621 35.94 67.215V67.215C37.6205 68.1953 39.7783 67.6055 40.7265 65.9067L73.3234 7.5039C74.2545 5.83574 73.6787 3.72923 72.0285 2.76663V2.76663C70.3559 1.79095 68.2091 2.35591 67.2334 4.02851L65.5 7Z"
                        stroke="white" stroke-width="3" />
                    <path
                        d="M25 21.5L11.5339 34.9661C11.2391 35.2609 11.2391 35.7391 11.5339 36.0339L25 49.5C26.3807 50.8807 26.3807 53.1193 25 54.5V54.5C23.6193 55.8807 21.3807 55.8807 20 54.5L2.317 36.817C1.58964 36.0896 1.58964 34.9104 2.317 34.183L20 16.5C21.3807 15.1193 23.6193 15.1193 25 16.5V16.5C26.3807 17.8807 26.3807 20.1193 25 21.5V21.5Z"
                        stroke="white" stroke-width="3" />
                    <path
                        d="M84.5 49.5L97.9661 36.0339C98.2609 35.7391 98.2609 35.2609 97.9661 34.9661L84.5 21.5C83.1193 20.1193 83.1193 17.8807 84.5 16.5V16.5C85.8807 15.1193 88.1193 15.1193 89.5 16.5L107.183 34.183C107.91 34.9104 107.91 36.0896 107.183 36.817L89.5 54.5C88.1193 55.8807 85.8807 55.8807 84.5 54.5V54.5C83.1193 53.1193 83.1193 50.8807 84.5 49.5V49.5Z"
                        stroke="white" stroke-width="3" />
                </svg>
            </div>
    ...
    <div
        class="leading-9 text-gray-100 hover:bg-black hover:bg-opacity-30 {{ request()->is('about') ? '!bg-black !bg-opacity-30' : '' }}">
...
<div class="flex items-center gap-2">
    ...
    <div id="dropdown" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="top"
        class="z-10 items-center hidden bg-white divide-y divide-gray-100 rounded-md ">
