        ...
        <div class="text-white flex flex-col gap-[10px] pt-5 fixed top-0 bottom-0 lg:right-0 w-[220px] bg-[#1E458A]">
            ...
            <div class="leading-9 text-gray-100 hover:bg-black hover:bg-opacity-30">
                <a href="{{ route('document') }}" class=" lg:right-0 pr-2.5 mt-1 flex items-center">
                    <div class="pl-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="20" viewBox="0 0 512 512">
                    ...
                    <h1 class="lg:right-0 text-gray-200 text-[15px] ml-2">المستندات</h1>
                </a>
            </div>
            <div class="leading-9 text-gray-100 hover:bg-black hover:bg-opacity-30">
            ...
            <div class="leading-9 text-gray-100 hover:bg-black hover:bg-opacity-30">
                ...
                <a href="{{ route('document') }}" type="button"
                    class="font-normal w-44 rounded-lg transition duration-75 group hover:bg-[#FFC657] lg:right-0 mr-2.5 mt-4 flex items-center">
                    <div class="pl-3">
                ...
                <div class=" lg:right-0 pr-2.5 mt-4">
                    <button type="button"
                        class="flex items-center text-[15px] font-normal rounded-lg transition duration-75 group hover:bg-[#FFC657]"
            ...
            <div class="flex items-center gap-2">
                <button type="button" class="my-6" id="user-menu-button" aria-expanded="false"
