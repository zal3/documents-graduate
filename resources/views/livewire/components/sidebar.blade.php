<div
    class="text-white flex flex-col gap-[10px] justify-between  pt-5 fixed top-0 bottom-0 lg:right-0 w-[220px] bg-[#1E458A]">
    <div class="">
        ...
        <div
            class="leading-9 text-gray-100 hover:bg-black pr-3 hover:bg-opacity-30 {{ request()->is('document') ? '!bg-black !bg-opacity-30' : '' }}">
                ...
                <div class="pl-3">
                    <svg width="34" height="19" viewBox="0 0 512 512">
                        ...
                        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="32" d="M256 56v120a32 32 0 0 0 32 32h120" />
                    </svg>
                </div>
        ...
        <div
            class="leading-9 text-gray-100 hover:bg-black  pr-3 hover:bg-opacity-30 {{ request()->is('unid') ? '!bg-black !bg-opacity-30' : '' }}">
            <a href="{{ route('unid') }}" class="lg:right-0 pr-2.5 mt-1 flex items-center">
                <div class="pl-3">
                    <svg width="34" height="19" viewBox="0 0 24 24">
                        <path fill="currentColor"
                            d="M5 21q-.825 0-1.413-.587Q3 19.825 3 19V5q0-.825.587-1.413Q4.175 3 5 3h11l5 5v11q0 .825-.587 1.413Q19.825 21 19 21Zm0-2h14V9h-3q-.425 0-.712-.288Q15 8.425 15 8V5H5Zm3-2h8q.425 0 .712-.288Q17 16.425 17 16t-.288-.713Q16.425 15 16 15H8q-.425 0-.713.287Q7 15.575 7 16t.287.712Q7.575 17 8 17Zm0-8h3q.425 0 .713-.288Q12 8.425 12 8t-.287-.713Q11.425 7 11 7H8q-.425 0-.713.287Q7 7.575 7 8t.287.712Q7.575 9 8 9Zm0 4h8q.425 0 .712-.288Q17 12.425 17 12t-.288-.713Q16.425 11 16 11H8q-.425 0-.713.287Q7 11.575 7 12t.287.712Q7.575 13 8 13ZM5 5v4v-4v14Z" />
                    </svg>
                </div>
            ...
            <ul id="dropdown-example" class="hidden py-4 mr-5 space-y-2">
                <li>
                    <a href="{{ route('graduate') }}"
                        class="flex items-center w-full text-sm text-gray-400 group hover:text-white focus:text-white">
                        الخريجين </a>
                </li>

                <li>
                    <a href="{{ route('add-graduate') }}"
                        class="flex items-center w-full text-sm font-normal text-gray-400 group hover:text-white focus:text-white">
                        أضافة</a>
                </li>
            </ul>
        </div>
            ...
            <ul id="dropdown-examplee" class="hidden py-4 mr-5 space-y-2">
                <li>
                    <div class=" lg:right-0">
                        <button
                            class="flex items-center text-sm text-gray-400 transition duration-75 group hover:text-white focus:text-white"
                            aria-controls="dropdown-exampleee" data-collapse-toggle="dropdown-exampleee">
                        ...
                        <ul id="dropdown-exampleee" class="hidden py-4 mr-5 space-y-2">
                            <li>
                                <a href="{{ route('science-subject') }}"
                                    class="flex items-center w-full text-sm text-gray-400 group hover:text-white focus:text-white">
                                    المناهج </a>
                            </li>
                            <li>
                                <a href="{{ route('science-student') }}"
                                    class="flex items-center w-full text-sm font-normal text-gray-400 group hover:text-white focus:text-white">
                                    الخريجيين</a>
                            </li>
                        </ul>
                ...
                <li>
                    <div class=" lg:right-0">
                        <button
                            class="flex items-center text-sm text-gray-400 transition duration-75 group hover:text-white focus:text-white"
                            aria-controls="dropdown-exampleeee" data-collapse-toggle="dropdown-exampleeee">
                        ...
                        <ul id="dropdown-exampleeee" class="hidden py-4 mr-5 space-y-2">
                            <li>
                                <a href="{{ route('information-subject') }}"
                                    class="flex items-center w-full text-sm text-gray-400 group hover:text-white focus:text-white">
                                    المناهج </a>
                            </li>
                            <li>
                                <a href="{{ route('information-student') }}"
                                    class="flex items-center w-full text-sm font-normal text-gray-400 group hover:text-white focus:text-white">
                                    الخريجيين</a>
                            </li>
                        </ul>
        ...
        <div
            class="leading-9 text-gray-100 hover:bg-black pr-3 hover:bg-opacity-30 {{ request()->is('developers') ? '!bg-black !bg-opacity-30' : '' }}">
            <a href="{{ route('developers') }}" class=" lg:right-0 pr-2.5 mt-1 flex items-center">
                <div class="pl-3">
                    <svg width="30" height="20" viewBox="0 0 108 68" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M64.5 6L33.653 61.5246C32.7345 63.1779 33.3064 65.2621 34.94 66.215V66.215C36.6205 67.1953 38.7783 66.6055 39.7265 64.9067L72.3234 6.5039C73.2545 4.83574 72.6787 2.72923 71.0285 1.76663V1.76663C69.3559 0.790946 67.2091 1.35591 66.2334 3.02851L64.5 6Z"
                            fill="white" />
                        <path
                            d="M24 20.5L10.5339 33.9661C10.2391 34.2609 10.2391 34.7391 10.5339 35.0339L24 48.5C25.3807 49.8807 25.3807 52.1193 24 53.5V53.5C22.6193 54.8807 20.3807 54.8807 19 53.5L1.317 35.817C0.589641 35.0896 0.58964 33.9104 1.317 33.183L19 15.5C20.3807 14.1193 22.6193 14.1193 24 15.5V15.5C25.3807 16.8807 25.3807 19.1193 24 20.5V20.5Z"
                            fill="white" />
                        <path
                            d="M83.5 48.5L96.9661 35.0339C97.2609 34.7391 97.2609 34.2609 96.9661 33.9661L83.5 20.5C82.1193 19.1193 82.1193 16.8807 83.5 15.5V15.5C84.8807 14.1193 87.1193 14.1193 88.5 15.5L106.183 33.183C106.91 33.9104 106.91 35.0896 106.183 35.817L88.5 53.5C87.1193 54.8807 84.8807 54.8807 83.5 53.5V53.5C82.1193 52.1193 82.1193 49.8807 83.5 48.5V48.5Z"
                            fill="white" />
                    </svg>
        ...
        <div
            class="leading-9 text-gray-100 hover:bg-black pr-3 hover:bg-opacity-30 {{ request()->is('about') ? '!bg-black !bg-opacity-30' : '' }}">
    ...
    <button class="flex items-center gap-2 mr-6">
        <button class="flex items-center my-6" id="user-menu-button" aria-expanded="false"
        ...
        <div id="dropdown" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="top"
            ...
            <form method="POST" action="{{ route('logout') }}" class="" x-data>
                @csrf
                <button type="submit"
                    class="block px-4   py-2 w-full text-center text-blue-500 hover:bg-[#071F63]  rounded-md hover:text-white ">
                    تسجيل خروج </button>
            </form>
        </div>
    </button>
