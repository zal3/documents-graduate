    ...
    <div>
        <div class="text-white pt-5 fixed top-0 bottom-0 lg:right-0 w-[220px] bg-[#1E458A]">
            <div  class="text-gray-100 leading-9">
                <a href="{{ route('document') }}" type="button" class="font-normal w-44 rounded-lg transition duration-75 group hover:bg-[#FFC657] lg:right-0 pr-2.5 mt-1 flex items-center">
                    <div class="pl-3">
                ...
                <a href="{{ route('unid') }}" type="button" class="font-normal w-44 rounded-lg transition duration-75 group hover:bg-[#FFC657] lg:right-0 pr-2.5 mt-1 flex items-center">
                    <div class="pl-3">
