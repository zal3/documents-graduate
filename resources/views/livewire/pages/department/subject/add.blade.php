        ...
        <div class="absolute top-0 bottom-0 left-0 right-0 z-10 py-12 transition duration-150 ease-in-out bg-black bg-opacity-70" id="modal">
            <div class="container w-11/12 max-w-lg mx-auto md:w-2/3">
                <div class="relative px-5 py-8 bg-white border border-gray-400 rounded shadow-md md:px-10">
                    ...
                    <input id="name" required wire:model="name_ar" class="flex items-center w-full h-10 px-3 pl-3 mt-2 mb-5 text-sm font-normal text-gray-600 border border-gray-300 rounded focus:outline-none focus:border focus:border-indigo-700" placeholder="" />
                    ...
                    <div class="flex items-center justify-start w-full gap-5">
                        ...
                        <a href="{{ route('science-subject') }}" class="px-8 py-2 ml-3 text-sm text-gray-600 transition duration-150 ease-in-out bg-gray-100 border rounded  hover:border-gray-400 hover:bg-gray-300">
                            الغاء
                        </a>
                    </div>
                </div>
