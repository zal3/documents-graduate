        ...
        <table class="min-w-full text-center">
            ...
            <tbody class="bg-white p-9">
                ...
                <tr class="bg-white p-9">
                    ...
                    <td class="px-6 py-4 text-lg leading-5 text-red-600 whitespace-no-wrap border-b border-gray-500">
                ...
                @empty
                <tr>
                    <td colspan="4" class="text-center text-3xl pt-12 font-bold  text-[#071F63]">اختر المرحلة و الكورس </td>
                </tr>
                @endforelse
            </tbody>
        </table>
