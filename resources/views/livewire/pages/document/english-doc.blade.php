        ...
        <div>
            <div>
                ...
                <div class="flex w-2/3 gap-2">
                    <input wire:model="search" required type="text" class="block w-2/3 p-2 text-sm text-gray-900 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder=" Choose the student">
                    @if ($search)
