            ...
            <div class="flex mx-[100px]">
                <div class="left-0 mt-20 text-left text-md">
                    ...
                    <span class="text-lg text-left">
                        ...
                        @if ($average > 0)
                        with a grade of (
                        @if ($average <= 50) Weak @elseif($average <=60) Acceptable @elseif($average <=70) middle @elseif($average <=80) good @elseif($average <=90) very good @elseif($average <=100) Excellent @endif ) and a graduation rate of ( {{ number_format($average, 2) }} ) @endif </span>
                </div>
            </div>
        </div>
        {{-- * Tail Compartment --}}
