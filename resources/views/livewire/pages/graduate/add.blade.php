        ...
        <div class="grid mx-auto mt-6  grid-cols-2 w-3/4 gap-4 m-4 items-center">
            ...
            <div>
                ...
                <div class="flex  gap-2">
                    <input wire:model="search" required type="text" class="block  p-2 text-sm text-gray-900 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder=" اختر الامر الجامعي ">
                    @if ($search)
                    <select wire:model="unid_id" required class="border border-gray-300 px-9 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
