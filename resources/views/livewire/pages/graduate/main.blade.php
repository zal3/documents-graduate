      ...
      <table class="min-w-full text-center">
         ...
         <tbody class="bg-white p-9">
            ...
            <tr class="bg-white p-9">
               ...
               <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">
                  @if($student->unid->department->id == 1) علوم الحاسوب @else نظم المعلومات @endif
               </td>

               <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-blue-900 text-sm leading-5"> @if($student->gender == 0) ذكر @else انثى @endif</td>
               <!-- //if stage -->
               <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">
                  <span class="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                     <span aria-hidden class="absolute inset-0 @if($student->unid->round == 0) bg-green-200 @elseif($student->unid->round == 1) bg-red-200 @else bg-gray-200  @endif opacity-50 rounded-full"></span>

                     <span class="relative text-xs">
                        @if($student->unid->round == 0) الاول @elseif($student->unid->round == 1) الثاني @else الثالث @endif
                     </span>
               ...
               <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">
                  <span class="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                     <span aria-hidden class="absolute inset-0 @if($student->unid->type == 0) bg-green-200 @else bg-red-200 @endif opacity-50 rounded-full"></span>
