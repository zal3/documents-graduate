        ...
        <div class="flex flex-col justify-between gap-2">
            ...
            <div class="flex items-center">
                ...
                <a href="{{ route('add-unid') }}">
                    <button class=" mx-auto transition duration-150 ease-in-out   bg-[#FFC657] rounded text-black px-4 sm:px-8 py-2 text-md">اضافة
                        امر </button>
                </a>
            </div>
        </div>
        ...
        <table class="min-w-full text-center">
            ...
            <tbody class="bg-white p-9">
                ...
                <tr class="bg-white p-9">
                    ...
                    <td class="px-6 py-4 flex gap-3 text-lg leading-5 text-red-600 whitespace-no-wrap border-b border-gray-500">
                        <button wire:click="confirm({{ $unid->id }})">
                            <i class="fa-regular fa-trash-can"></i>
                        </button>
                        <a href="{{ route('unidstu', $unid->id) }}" class="px-5 py-2 border-[#071F63] border text-[#071F63] rounded transition duration-300 hover:bg-[#071F63]  hover:text-white focus:outline-none">عرض
                            التفاصيل </a>
                    </td>
                </tr>
                @empty
                ...
                <tr>
                    <td colspan="8" class="text-center text-5xl pt-12 font-bold  text-[#071F63]">لا يوجد بيانات</td>
                </tr>
                @endif
                @endforelse
            </tbody>
